...
// *
// * <p>More specifically, this codec maps an arbitrary {@link JsonStructure} to a CQL {@code
// varchar}
// * column.
// *
// * <p>This codec handles the Java type {@link JsonStructure}. It is therefore required that values
// * are set and retrieved using that exact Java type; users should manually downcast to either
// {@link
...
//  @Nullable
//  @Override
//  public ByteBuffer encode(@Nullable JsonStructure value, @NonNull ProtocolVersion
// protocolVersion) {
//    return null;
//  }
//
//  @Nullable
//  @Override
//  public JsonStructure decode(@Nullable ByteBuffer bytes, @NonNull ProtocolVersion
// protocolVersion) {
//    return null;
//  }
//
